...
const App = {
    ...
    openTeleprompter(text) {
        ...
        win.document.write('<input type="range" min="10" max="200" value="40" id="speed-slider" oninput="speedVal=parseInt(this.value)">');
        ...
        win.document.write('var y=window.innerHeight, lastTime=0, speedVal=40;');
        ...
        win.document.write('  y-=speedVal*0.002*dt;');
